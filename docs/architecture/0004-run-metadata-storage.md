...
support "many independent runs over a long time, across many batteries."
...
`runs/{battery}/{scenario}/{run_id}/`, validated against
...
server. Reporting is automatically data-driven -- a new battery shows up
...
thousands) if reporting ever needs ad hoc cross-battery querying beyond what
