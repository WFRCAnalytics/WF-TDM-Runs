...
per scenario. Must be run while runs/shorten-longest-commutes still has
curated outputs -- there's nothing left to freeze from otherwise. Mirrors
bring-work-trips-closer-to-home/report_snapshot.py exactly -- same
