"""report_snapshot_script for bring-work-trips-closer-to-home (see
run_set.yaml). Invoked by `tdmruns snapshot-run-set --run-set
bring-work-trips-closer-to-home` as:
...
per scenario. Must be run while runs/bring-work-trips-closer-to-home still
...
.omx files' own HDF5 compression (confirmed empirically: Skm_AM.omx was
37 MB, HBW_trips_allsegs_Pk.omx was 12 MB for the same scenario).
"""
import argparse
import os
import sys
